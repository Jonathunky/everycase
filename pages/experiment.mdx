...
<Tabs
  items={["iPhone 13", "iPhone 13 mini", "iPhone 13 Pro", "iPhone 13 Pro Max"]}
>
  <Tabs.Tab>Pure Markdown</Tabs.Tab>
  <Tabs.Tab>
    | | Leather Wallet | | ---------------- | -------------- | | Baltic Blue |
    MHLQ3ZM/A | | Black | MHLR3ZM/A | | California Poppy | MHLP3ZM/A | | Saddle
    Brown | MHLT3ZM/A |
  </Tabs.Tab>
  <Tabs.Tab>
    | | Leather Wallet | | ---------------- | -------------- | | Baltic Blue |
