...
| --- | --- | --- |
| Taupe | MPQL2<wbr/>ZM/A | <Link href="/others/pencil/MPQL2" scroll={true}><img src="/everypreview/MPQL2.webp" alt="Taupe Leather Case"/></Link> |
| Saddle Brown | MQ0V2<wbr/>ZM/A | <Link href="/others/pencil/MQ0V2" scroll={true}><img src="/everypreview/MQ0V2.webp" alt="Saddle Brown Leather Case"/></Link> |
| Midnight Blue | MQ0W2<wbr/>ZM/A | <Link href="/others/pencil/MQ0W2" scroll={true}><img src="/everypreview/MQ0W2.webp" alt="Midnight Blue Leather Case"/></Link> |
| Black | MQ0X2<wbr/>ZM/A | <Link href="/others/pencil/MQ0X2" scroll={true}><img src="/everypreview/MQ0X2.webp" alt="Black Leather Case"/></Link> |

## Part numbers // Late 2017 drop

| Color | SKU | Tap for more: |
| --- | --- | --- |
| Red | MR552<wbr/>FE/A | <Link href="/others/pencil/MR552" scroll={true}><img src="/everypreview/MR552.webp" alt="Red Leather Case"/></Link> |
| Fuchsia | MR582<wbr/>FE/A | <Link href="/others/pencil/MR582" scroll={true}><img src="/everypreview/MR582.webp" alt="Fuchsia Leather Case"/></Link> |

## Part numbers // Spring 2018

| Color | SKU | Tap for more: |
| --- | --- | --- |
| Electric Blue | MRFN2<wbr/>ZM/A | <Link href="/others/pencil/MRFN2" scroll={true}><img src="/everypreview/MRFN2.webp" alt="Electric Blue Leather Case"/></Link> |
| Soft Pink | MRFP2<wbr/>ZM/A | <Link href="/others/pencil/MRFP2" scroll={true}><img src="/everypreview/MRFP2.webp" alt="Soft Pink Leather Case"/></Link> |
